...
type TheatreV2LayoutOptions = {
  detailLayout?: ProjectLayout;
  layoutId?: ProjectLayout;
};

type TheatreV2LayoutProps = ProjectLayoutProps & TheatreV2LayoutOptions;

export default function TheatreV2Layout({
  project,
  others,
  stackLinks,
  detailLayout = 'theatre_v2',
  layoutId = 'theatre_v2',
}: TheatreV2LayoutProps) {
